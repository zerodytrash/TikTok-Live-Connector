    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.coinCount = longToNumber(reader.uint64());
          continue;
        }
        case 2: {
          if (tag !== 18) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8: {
          ...
          message.receiverUserId = longToNumber(reader.uint64());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const WebcastLinkMicArmiesItems: MessageFns<WebcastLinkMicArmiesItems> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.hostUserId = longToNumber(reader.uint64());
          continue;
        }
        case 2: {
          if (tag !== 18) {
  ...
  fromJSON(object: any): WebcastLinkMicArmiesItems {
    return {
      hostUserId: isSet(object.hostUserId) ? globalThis.Number(object.hostUserId) : 0,
  ...
  toJSON(message: WebcastLinkMicArmiesItems): unknown {
    const obj: any = {};
    if (message.hostUserId !== 0) {
      obj.hostUserId = Math.round(message.hostUserId);
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 2: {
          ...
          message.msgId = longToNumber(reader.uint64());
          continue;
        }
        case 4: {
          if (tag !== 32) {
