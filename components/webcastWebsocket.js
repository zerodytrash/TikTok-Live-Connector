...
class WebcastWebsocket extends websocket.client {
    constructor(wsUrl, cookieJar, clientParams, wsParams) {
        super();
        this.pingInterval = null;
        this.connection = null;
        this.wsParams = Object.assign(wsParams, clientParams);
        this.wsUrlWithParams = `${wsUrl}?${new URLSearchParams(this.wsParams)}`;
        this.wsHeaders = {
            'Cookie': cookieJar.getCookiesSync(Config.TIKTOK_URL_WEB)
        }
